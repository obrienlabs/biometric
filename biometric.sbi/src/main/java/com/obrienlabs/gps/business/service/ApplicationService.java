package com.obrienlabs.gps.business.service;
...
//		User aUser = new User();
    ...
    public String activeId() {
	    ...
	    query.orderBy(
	    		cb.desc(target.get(tsStopAttribute)));
	    query.distinct(true);
	    TypedQuery<Long> typedQuery = entityManager.createQuery(query);
	...
	@Override
	public String captureImage(OutputStream out, String fullURL) throws Exception {
